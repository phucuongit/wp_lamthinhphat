...
jQuery(function ($) {
  ...
  $('body').on('blur change', '#billing_phone', function () {
    var wrapper = $(this).closest('.form-row'); // you do not have to removeClass() because Woo do it in checkout.js

    if (!/^(0[35789]|09)[0-9]{8}$/.test($(this).val())) {
  ...
  $('body').on('blur change', '#billing_email', function () {
    ...
    var result = $(this).val().match(patt); // you do not have to removeClass() because Woo do it in checkout.js
